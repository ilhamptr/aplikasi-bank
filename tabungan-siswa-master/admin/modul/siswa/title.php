...
<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
 ...
 <div class="form-group">
    <label>NISN</label>
  <input type="text" class="form-control" id="exampleInputEmail1" name="nisn" aria-describedby="emailHelp" placeholder="Masukkan NISN">
    <small id="emailHelp" class="form-text text-muted">Masukkan nomor NISN</small>
  </div>
 <div class="form-group">
